...
public class SoccerNewsRepository {
    ...
    //region Attributes: encapsulate access to our API (Retrofit) and local database (Room).
    ...
    //region Singleton: guarantees a single instance of attributes related to Retrofit and Room.
